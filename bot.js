        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '```🛡️ QUEEN ALEXA අනාවරණය විය!``` \n```පරිශීලක:``` \n```හේතුව:``` ', MessageType.text)

                    await new Promise(r => setTimeout(r, 1700));

                    console.log('🛡️ QUEEN ALEXA Detected 🛡️')
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '```🛡️ QUEEN ALEXA Detected!``` \n```User:```  \n```Reason:``` ', MessageType.text)
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- දෝෂ වාර්තාව [QUEEN ALEXA] --*' + 
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- බොට් වාර්තාව [QUEEN ALEXA] --*' + 
                                    ...
                                    '\n_ඔබේ bot සඳහා යම් උදව්වක් අවශ්‍ය නම්, _\n\n':https://chat.whatsapp.com/ESgq5ThSobg4ZGD4pLAGf4
                                    '*Report:* ```' + error + '```\n\n'
                                    , MessageType.text);
                            }
                        }
